        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-primary">
            <div class="container">
                ...
                <div class="collapse navbar-collapse"
                    ...
                    <hr class="d-lg-none text-white-50">
                    <a href="<?php echo e(route('profile')); ?>" class="btn btn-outline-light my-2 ms-md-auto"><i class="bi-person-circle me-1"></i> My
                        Profile</a>
                </div>
            </div>
        </nav>
...
<?php /**PATH E:\Php\sems4-barang\resources\views/employee/index.blade.php ENDPATH**/ ?>